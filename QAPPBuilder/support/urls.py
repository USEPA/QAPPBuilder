...
urlpatterns = [
    ...
    re_path(r'^files/(?P<file_name>.+)', event_file_download,
    ...
    re_path(r'^show/(?P<support_type_name>\w+)/(?P<obj_id>\d+)/$',
        show_support, name='show_support'),

    # new
    re_path(r'^file/upload/(?P<obj_id>\d+)/$', file_upload_support,
    ...
    re_path(r'^type/show/(?P<obj_id>\d+)/$', show_support_type,
        name='show_support_type'),

    re_path(r'^priority/create/$', create_priority, name='create_priority'),
    re_path(r'^priority/edit/(?P<obj_id>\d+)/$', edit_priority,
        name='edit_priority'),
    re_path(r'^priority/delete/(?P<obj_id>\d+)/$', delete_priority,
        name='delete_priority'),
    re_path(r'^priority/list/$', list_priorities, name='list_priorities'),
    re_path(r'^priority/show/(?P<obj_id>\d+)/$', show_priority,
        name='show_priority'),
]
