...
class TestTeams(TestCase):
    ...
    def test_team_create_view_get(self):
        ...
        self.assertContains(response, 'create', 4, 200)
    ...
    def test_team_edit_view_get(self):
        ...
        response = self.client.get("/teams/team/" + url_object_number +
                                   "/edit")
    ...
    # ########################################################################
    # TODO: These two POST methods are failing, resulting in 302 (redirect)
    ...
    def test_team_management_view_get(self):
        ...
        response = self.client.get("/teams/team/" + url_object_number +
                                   "/manage")
        self.assertContains(response, 'manage', 2, 200)
